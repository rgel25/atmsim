...
const account3 = {
  owner: 'Adam Kovic',
  movements: [200, 9000, -4000, -200, -500, -1000, 1900, -300],
  interestRate: 1.5,
  pin: 3333,
...
const account4 = {
  owner: 'James Willems',
  movements: [2500, 3400, -150, -790, -800, 25000, 8500, -5000],
  interestRate: 1.5,
  pin: 4444,
...
const startLogOutTimer = function () {
  const tick = () => {
    ...
    // if timer = 0, stop timer and logout user
    if (time === 0) {
      clearInterval(timer);
...
const userDemoBtns = document.querySelectorAll('.demo--user');

userDemoBtns.forEach((btn, i) => {
  btn.addEventListener('click', () => {
    if (i === 0) {
      inputLoginUsername.value = 'am';
      inputLoginPin.value = 1111;
      closeModal();
    } else if (i === 1) {
      inputLoginUsername.value = 'bg';
      inputLoginPin.value = 2222;
      closeModal();
    } else if (i === 2) {
      inputLoginUsername.value = 'ak';
      inputLoginPin.value = 3333;
      closeModal();
    } else if (i === 3) {
      inputLoginUsername.value = 'jw';
      inputLoginPin.value = 4444;
      closeModal();
    }
  });
});
